...
CharCode charCodes[256] = {
    ...
    CHAR_SPACE, CHAR_EXCLAIMATION, CHAR_DOUBLEQUOTE, CHAR_UNKNOWN, CHAR_UNKNOWN, CHAR_MODUL, CHAR_UNKNOWN, CHAR_SINGLEQUOTE,
    ...
    CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER,
    CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LSB, CHAR_UNKNOWN, CHAR_RSB, CHAR_UNKNOWN, CHAR_UNDERSCORE,
